...
class ConstantBufferTest : public UnitTestBase
{
public:
...
public:
	...
	ConstantBufferTest(unsigned width, unsigned height, const char* name)
	...
	cbuffer test_buffer : register(b0)
	{
		float4 color;
	};
